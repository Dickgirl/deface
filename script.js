...
const musicHelper = (function(){
 ...
 let audio  = new Audio( 'https://ice1.somafm.com/groovesalad-128-mp3' );
 let step   = 0.01;
 let active = false;
 let sto    = null;
...
var app = {
  ...
  chars: ['Exxploiting','Hellsec','Envy','Zalgo','antichrist#0001','Blake','Anthony Fitim','Twisty','Meowth','Nylon','federal','I9','Marley','sorrwo','big blrrd','Essence','hovering','RootKomodo','meds','byte'],
